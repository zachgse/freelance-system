        ...
        <div class="border-1 border-gray-300 w-full h-auto flex flex-col justify-center mx-auto my-12 p-4">
            <div class="grid grid-cols-12">
                <div class="col-span-12">
                    <p class="font-bold text-xl">Job Details</p>
                    <div class="border-b border-gray-300 p-4">
                        <p class="font-bold text-lg">{{ freelanceDetails?.title }}</p>
                    ...
                    <div class="border-b border-gray-300 p-4">
                        ...
                        <span class="text-white py-1 px-10 rounded-full bg-blue-500 text-xs">{{ freelanceDetails?.category  }}</span>
                    </div>
                    ...
                    <div class="px-4 mt-4">
                        <p class="text-lg font-bold text-gray-500">{{ clientDetails?.client_name }}</p>
                    </div>
                    <div class="px-4 mt-4">
                        <p class="text-xs font-bold text-gray-500">{{ clientDetails?.number_of_total_projects }} job/s posted</p>
                    </div>
                    <div class="px-4 mt-4">
